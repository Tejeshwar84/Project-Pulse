      ...
      <div className="mb-6">
        <div className="flex items-start justify-between">
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              {project.riskScore >= 70 && (
                <span className="text-xs bg-rose/20 text-rose px-2.5 py-1 rounded-full border border-rose/20 font-medium">
                  ⚠ High Risk
                </span>
              )}
              <span
          ...
          <div className="text-right glass rounded-xl px-5 py-3">
            <p
              className={`text-lg font-display font-bold ${daysLeft <= 7 ? "text-rose" : daysLeft <= 14 ? "text-amber" : "text-white"}`}
            >
